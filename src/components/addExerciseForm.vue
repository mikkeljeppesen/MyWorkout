<template>
  <div class="addExerciseForm">
    ...
    <div class="input-wrapper">
      <label for="exerciseWeight">Start weight</label>
      <input type="text" id="exerciseWeight" v-model="exerciseWeight">
    </div>

      <a v-on:click="addExercise" class="btn action"><i class="fa fa-check" aria-hidden="true"></i></a>
      <a v-on:click="cancel" class="btn cancel"><i class="fa fa-ban" aria-hidden="true"></i></a>
  </div>
</template>
